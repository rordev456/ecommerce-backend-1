...
whiteShirt = Product.create({name: "White Shirt", price: 50, description: "The staple shirt in any man's closet.", category: shirts, img: "https://imgur.com/Beb11Nm" })
...
blueShirt = Product.create({name: "Blue Shirt", price: 50, description: "The classic perfect color.", category: shirts, img: "https://imgur.com/dsr0MCf"})
navyTrousers = Product.create({name: "Navy Trousers", price: 100, description: "The go to.", category: trousers, img: "https://imgur.com/KFTZfld"})
pinstripeTrousers = Product.create({name: "Pinstripe Trousers", price: 100, description: "The Gatsby style.", category: trousers, img: "https://imgur.com/bHIKbNq"})
whiteTrousers = Product.create({name: "White Trousers", price: 100, description: "The special occasion trousers.", category: trousers, img: "https://imgur.com/Mu9zDdb"})
doubleBreastedSuit = Product.create({name: "Double Breasted Pinstripe Suit", price: 500, description: "Straight outta The Godfather.", category: suits, img: "https://imgur.com/Se8re2A"})
blackTuxedo = Product.create({name: "Black Tuxedo", price: 500, description: "For the definition of elegance.", category: suits, img: "https://imgur.com/VqzINUB"})
navySuit = Product.create({name: "Navy Suit", price: 500, description: "Classic.", category: suits, img: "https://imgur.com/b4mCVpD"})
navyCheckSuit = Product.create({name: "Navy Check Suit", price: 500, description: "Checks over stripes.", category: suits, img: "https://imgur.com/N7CMIWp"})
